    ...
    internal class FileUploadTabPage : TabPage
    {
        ...
        private void showActivityDetails(List<Activity> activitiesList)
        {
            ...
            foreach (Activity activityItem in activitiesList) {
                ...
                if (activityItem is WorkoutActivity) {
                    activity = (WorkoutActivity) activityItem;
                }
                else if (activityItem is RunActivity)
                {
                    activity = (RunActivity) activityItem;
                }
                else if (activityItem is HikeActivity)
                {
                    activity = (HikeActivity)activityItem;
                }
                else if (activityItem is BikeRideActivity)
                {
                    activity = (BikeRideActivity)activityItem;
                }
                ...
                activityDurationValueLabel.Text = activity.FormatedDuration;
                ...
                addActivityButton.Click += (s,e) => Activity.AddActivity(activity);
